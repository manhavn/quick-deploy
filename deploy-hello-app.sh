...
ENV_FOLDER="env"
PROJECT_HANDLE="hello-app"
APP_HANDLE="quick-deploy"
DEPLOY_HOST="root@app-hello.my-domain.dev"
...
# curl -X PUT https://app-hello.my-domain.dev/server/frontend/upload -H "Content-Type: multipart/form-data" -F "dist=@./dist.zip;type=application/zip"
